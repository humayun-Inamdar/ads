...
body {
  ...
  <script>
     ...
     <h3> 
         ...
         <a href="logout.jsp"><font color="white">Logout</font></a>&nbsp&nbsp&nbsp&nbsp
             <a href="pcd.jsp"><font color="white">More Details</font></a>
        </h3>   
                  <br>
</head>
<body>
 ...
 if(resultset.next()){
	  userID = resultset.getString("pid");
           ...
           // resultset =  statement.executeQuery("select m_name,Ad_request,Bilable_impression,count,fill_rate from m_content,p_content where m_content.a_name=p_content.m_name and pid='"+userID+"'");
            resultset = statement.executeQuery("select mid,a_name,date,domain,a_file,a_size,s_time1,time_sec1,s_time2,time_sec2,s_time3,time_sec3,cmp,status from m_content ");
         /* String aname = "";
 if(resultset.next()){
 ...
 <br>
  <h2> 
       <form action="Advertise.jsp" method="post">
			...
			<center><i>Customer Data</i></center></h2><br>
				<table>
					<thead>
						<tr>
							<th> Advertise name</th>
                                                        <th> ID&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                                                        <th>Date&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                                                          <th>Domain </th>
                                                           <th>Ads File</th>
                                                         <th>Ads size</th>
                                                          <th>Start Time1</th>
                                                         ...
                                                         <th>Ads_cmp</th>&nbsp&nbsp&nbsp&nbsp&nbsp
                                                          <th>  <input type="submit" name="btn1" value="Publish"></th>
                                                ...
                                                <% while(resultset.next()){ %>
                                                 <tbody>
						<tr>
							<td> <input type="checkbox" name="chk1" value="<%= resultset.getString(1) %>" id="chk" /><%= resultset.getString(1) %></td>
                                                          <td> <%= resultset.getString(2) %></td>
                                                          <td> <%= resultset.getString(3) %></td>
                                                          <td> <%= resultset.getString(4) %>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                                                          <td> <%= resultset.getString(5) %>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                                                         <td> <%= resultset.getString(6) %>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                                                          <td> <%= resultset.getString(7) %>&nbsp&nbsp&nbsp</td>
                                                          <td> <%= resultset.getString(8) %></td>
                                                          <td> <%= resultset.getString(9) %>&nbsp&nbsp&nbsp</td>
                                                          <td> <%= resultset.getString(10) %></td>
                                                          <td> <%= resultset.getString(11) %>&nbsp&nbsp&nbsp</td>
