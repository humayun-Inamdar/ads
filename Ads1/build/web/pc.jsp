...
<body>
 ...
 if(resultset.next()){
	  a_name = resultset.getString("a_name");
           ...
           // resultset =  statement.executeQuery("select m_name,Ad_request,Bilable_impression,count,fill_rate from m_content,p_content where m_content.a_name=p_content.m_name and pid='"+userID+"'");
            resultset = statement.executeQuery("select m_name,Ad_request,Bilable_impression,count,fill_rate from p_content where m_name='"+a_name+"' ");
          int Adr;
           int complete;
            float fr;
          //  fr=(complete/Adr)*100;
 ...
 if(resultset.next()){
	 Adr= resultset.getInt("Ad_request");
          complete= resultset.getInt("Bilable_impression");
         fr=(complete/Adr)*100;
