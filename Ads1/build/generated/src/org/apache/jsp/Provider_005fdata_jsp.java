...
public final class Provider_005fdata_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\n");
      out.write("                                    <tr><td><b>Provider ID:</b></td><td>   <input type=\"hidden\" placeholder=\"ID\" name=\"id\" required></td></tr>\n");
      out.write("                                      <tr><td><b>Date:</b></td><td>   <input type=\"date\" id=\"dt\" placeholder=\"Date\" name=\"d\"  required/></td></tr>\n");
      out.write("                                      <tr><td><b>Domain:</b></td><td>   <input type=\"text\" id=\"dm\" placeholder=\"Enter domain\" name=\"dm\" required></td></tr>\n");
      out.write("                                        <tr><td><b>Advertise name:</b></td><td>  <input type=\"text\" id=\"an\" placeholder=\"Enter Ad name\" name=\"ad\" required></td></tr>\n");
      out.write("\t\t\t\t\t<tr><td><b>Advertise File:</b></td><td> <input type=\"text\" id=\"af\" placeholder=\"Enter Ad File\" name=\"adf\" required></td></tr>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<!-- \n");
      out.write("\t\t\t\t\tMale<input type=\"radio\" name=\"gender\" value=\"male\"> Female<input type=\"radio\" name=\"gender\" value=\"female\"/><br/><br/> -->\n");
      out.write("\t\t\t\t\t<tr><td><b>Advertise Size:</b></td><td> <input type=\"text\" id=\"as\" placeholder=\"Enter Ad size\" name=\"s\" required></td></tr>\n");
      out.write("\t\t\t\t\t<tr><td><b>Currency:</b></td><td> <input type=\"text\" id=\"cr\" name=\"example\" list=\"exampleList\">\n");
      out.write("                                       <datalist id=\"exampleList\">\n");
      out.write("                                            <option value=\"Default\">Currency</option>\n");
      out.write("                                            <option value=\"AUD\">Australia</option>                     \n");
      out.write("                                            <option value=\"USD\">Netherlands</option>\n");
      out.write("                                            <option value=\"IRR\">Iran</option>\n");
      out.write("                                            <option value=\"INR\">India</option>\n");
      out.write("                                            <option value=\"BRL\">Brazil</option>\n");
      out.write("                                            </datalist></td></tr>\n");
      out.write("                                        <tr><td><b>CMP:</b></td><td> <input type=\"text\" id=\"cmp\" placeholder=\"Enter money\" name=\"cmp\" required></td></tr>\n");
      out.write("                                    ");
      out.write("         \n");
      out.write("\t\t\t\t\t<tr><td></td><td><input type=\"submit\" name=\"submit\" value=\"Submit\" onclick=\"f()\" />\n");
      out.write("\t\t\t\t\t\n");
